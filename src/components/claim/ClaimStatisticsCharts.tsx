...
const ClaimStatisticsCharts: React.FC<ClaimStatisticsChartsProps> = ({
  ...
  const [efficiency, setEfficiency] =
    useState<ProcessingEfficiencyStats | null>(null);
  ...
  const handleExportData = async () => {
    try {
      const exportData = await claimStatisticsService.exportStatisticsReport(
        caseId,
        dateRange,
      );
  ...
  const chartData = useMemo(() => {
    ...
    return {
      ...
      qualityMetrics: [
        {
          name: "一次通过率",
          value: quality.onePassRate,
          color: CHART_COLORS[0],
        },
        {
          name: "驳回率",
          value: quality.rejectionRate,
          color: CHART_COLORS[1],
        },
        {
          name: "补充材料率",
          value: quality.supplementRequestRate,
    ...
    <LocalizationProvider dateAdapter={AdapterDateFns} adapterLocale={zhCN}>
      <Box>
            ...
            <Grid item xs={12} sm={6} md={3}>
              <Card>
                <CardContent>
                  ...
                  <Typography color="textSecondary">天</Typography>
                </CardContent>
              </Card>
            </Grid>
            ...
            <Grid item xs={12} sm={6} md={3}>
              <Card>
                <CardContent>
                  ...
                  <Typography color="textSecondary">轮</Typography>
                </CardContent>
              </Card>
            </Grid>
          </Grid>
        ...
        <Grid container spacing={3}>
          {/* 处理时长分布 */}
          {chartData?.efficiencyTimeRanges &&
          ...
          {/* 质量指标 */}
          {chartData?.qualityMetrics &&
            (selectedMetric === "overview" || selectedMetric === "quality") && (
              <Grid item xs={12} md={6}>
                <Card>
                  <CardContent>
                    <Typography variant="h6" gutterBottom>
